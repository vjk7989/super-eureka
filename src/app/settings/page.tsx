...
export default function Settings({ searchParams }: { searchParams?: Record<string, string | string[] | undefined> }) {
  ...
  return <AppShell role={role}><PrototypeForm title="System Settings" fields={["Default model version", "Map style URL", "Inspection SLA days", "Export retention days"]} /></AppShell>;
}
