  ...
  return (
    <main className="grid min-h-screen place-items-center bg-background p-4 sm:p-6">
      <section className="w-full max-w-3xl rounded-lg border border-border bg-card p-5 shadow-md sm:p-6">
        <p className="text-xs font-semibold uppercase text-muted-foreground">Prototype login</p>
        <h1 className="mt-2 text-3xl font-semibold leading-tight">Oil Palm Health Command Center</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">Choose a persona to enter the clickable operational prototype. Supabase Auth replaces this switcher in the integration milestone.</p>
